...
<html lang=" pt-br">
  ...
  $newpesquisa = "Select * from controle where NOMEITEM='$nomeitem' ";
  ...
  while ($registro = mysqli_fetch_array($consulta)) {
    $loc = $registro[1];
            ...
            ";
                      ...
                      ?>
                        <li <?php echo $estilo; ?>><a href="listar_produtos.php?pagina=<?php echo $i;
                                                                                        echo "&nomeitem=$nomeitem&loc=$loc"; ?> "><?php echo $i; ?></a></li>
                      <?php }
        ...
        <div > <!-- codificando o arquivo para um array json e escondendo essa div-->
